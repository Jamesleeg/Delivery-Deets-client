...
import { postDelete, postUpdate, galleryNoUser } from '../api/post'
import moment from 'moment'

// 2. Class
class UserPostShow extends Component {
  constructor (props) {
    super(props)
    this.state = {
  ...
  componentDidMount () {
    ...
    galleryNoUser(user, match.params.id)
...
// 3. Exports
export default withRouter(UserPostShow)
